...
Для установки зависимостей для разработки (тестирование, линтеры, типизация и др.):
...
Проект требует следующие библиотеки Python (работает с Python ≥ 3.13):
...
Полный список зависимостей доступен в [`requirements.txt`](../../requirements.txt) для основных библиотек и в [`requirements-dev.txt`](../../requirements-dev.txt) для инструментов разработки, включая линтеры, проверку типов и тестовые фреймворки (`pytest`, `mypy`, `ruff` и др.).
...
* **tests/** — содержит все тестовые файлы для проверки работоспособности, стабильности и корректности основных модулей проекта.
